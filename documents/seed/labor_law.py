...
SEED_ACTS = [
    ...
    # прохождения приёмки:
    #   «О занятости населения в Российской Федерации» 565-ФЗ — ОТЛОЖЕН: активный
    #   закон 2023 г. не отдаётся классической ИПС через doc_itself (nd=102040866 —
    #   это ОТМЕНЁННЫЙ предшественник, Закон РФ 1032-1). Доступен лишь на
    #   publication.pravo.gov.ru (иной формат HTML — нужен отдельный парсер).
]
